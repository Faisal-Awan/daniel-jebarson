    ...
    <div id="resume" className="min-h-screen flex-col text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-7">
        <ol class="relative border-l  border-gray-700 ml-9 mb-6">
          ...
          <li class="mt-10" data-aos="zoom-in" data-aos-offset={"-15"} data-aos-delay="1300">
          ...
          <li class="mt-10" data-aos="zoom-out" data-aos-delay="700">
            <span class="absolute flex items-center justify-center w-6 h-6 rounded-full -left-3 ring-8 ring-gray-900 bg-blue-900">
              <svg
                aria-hidden="true"
                class="w-3 h-3 text-blue-300"
          ...
          <li class="mt-10" data-aos="zoom-in">
            <span class="absolute flex items-center justify-center w-6 h-6   rounded-full -left-3 ring-8  ring-gray-900 bg-blue-900">
              <svg
                aria-hidden="true"
                class="w-3 h-3  text-blue-300"
        ...
        <div className="flex flex-col text-center" data-aos="slide-up">
          ...
          <div className="ml-16 flex flex-col gap-8 mt-6">
            <BarGraph name={"JavaScript"} percent={55} />
            <BarGraph name={"React"} percent={60} />
            {/* <BarGraph name={"TypeScript"} percent={60} /> */}
            {/* <BarGraph name={"Java"} percent={80} /> */}
            <BarGraph name={"HTML/CSS"} percent={80} />
            <BarGraph name={"SQL"} percent={60} />
            {/* <BarGraph name={"AWS"} percent={40} /> */}
          </div>

          <a
            href={require("../../assets/files/Faisal Awan - ReactJs - UI - Javascript.pdf")}
            download={"Faisal's Resume"}
